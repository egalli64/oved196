--------------------------------------------------------
--  File creato - lunedì-febbraio-18-2019   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "OVED"."GREEN_TEAMS" 
   (	"TEAM_ID" NUMBER(*,0) GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"TEAM_NAME" VARCHAR2(30 BYTE) UNIQUE
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
SELECT GREEN_CODERS, GREEN_ROLES FROM GREEN_TEAMS NATURAL JOIN COD_ROLE NATURAL JOIN 

UPDATE GREEN_TEAMS SET TEAM_NAME = TEAM_NAME_UNIQUE-UNIQUE;
